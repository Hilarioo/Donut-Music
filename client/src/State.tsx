 ...
 */
const instruments = List([PianoInstrument, HilariooInstrument,RuiQiHuang1832Instrument]); // similar to Instrument[]

/**
 * Start with the default waveform visualizer.
 * Add your visualizers to this list.
 */
const visualizers = List([WaveformVisualizer, HilariooVisualizer, RuiQiHuang1832Visualizer]); // similar to Visualizer[]
